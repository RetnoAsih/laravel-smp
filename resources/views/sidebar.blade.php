...
<body class="g-sidenav-show   bg-gray-100">
 ...
 text-dark text-sm opacity-10"></i>
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('pelajaran') ? 'active' : '' }}" href="/pelajaran">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="ni ni-settings-gear-65
 text-dark text-sm opacity-10"></i>
            </div>
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('jadwal_guru') ? 'active' : '' }}" href="/jadwal_guru">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="ni ni-settings-gear-65
 text-dark text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Jadwal Guru</span>
        </a>
    </li>
