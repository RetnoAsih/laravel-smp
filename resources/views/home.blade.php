              ...
              <div class="row">
                <div class="col-lg-7 col-md-10" data-aos="fade-right" data-aos-delay="100">
                  <div class="content-box">
                    <span class="badge-accent" data-aos="fade-up" data-aos-delay="150">Sekolah Unggul, Berakhlak Mulia</span>
                  ...
                  <div class="col-lg-4">
                    <div class="feature-item" data-aos="fade-up" data-aos-delay="450">
                      ...
                      <div class="feature-text">
                        ...
                        <p>FEBRUARI-MEI 2025</p>
                        <ul>
                          <li>Free Tas Sekolah</li>
                          <li>Gratis Kaos Olahraga</li>
                          <li>Gratis Seragam Almamater</li>
                        </ul>
                      </div>
                    </div>
                  </div>
